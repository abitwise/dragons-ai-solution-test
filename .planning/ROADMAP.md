...
- [x] 01-03-PLAN.md — FakeApiClient: scripted offline test double implementing ApiClient

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 01-04-PLAN.md — HttpApiClient (TDD): zod boundary, retry-at-edge, encodeURIComponent, decode integration
...
- [x] 02-02-PLAN.md — Ad selection (TDD, STRAT-03): chooseAd by EV (reward×rank) with expiry-aware tiebreak, least-bad-gamble fallback, null on empty board
